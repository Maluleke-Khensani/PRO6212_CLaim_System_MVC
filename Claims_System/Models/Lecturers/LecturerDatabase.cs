...
namespace Claims_System.Models.Lecturers
{
    public class LecturerDatabase
    {
        ...
        public LecturerDatabase() 
        {
            ...
            lecturers.Add(new Lecturer { EmployeeNumber = 4, FullName = "Jayden Barron", Department = "Law", status = "Rejected", CoordinatorStatus="Rejected", ManagerStatus="Approved", Amount = 80000.00, hoursWorked = 200, Submitted = "2026-01-22", Month = "November 2025" });
            ...
            lecturers.Add(new Lecturer { EmployeeNumber = 6, FullName = "Emily Smith", Department = "Mathematics", status = "Pending", CoordinatorStatus = "Pending", ManagerStatus = "Pending", Amount = 60000.00, hoursWorked = 120, Submitted = "2026-03-15", Month = "January 2026" });
            lecturers.Add(new Lecturer { EmployeeNumber = 7, FullName = "Michael Johnson", Department = "Physics", status = "Pending", CoordinatorStatus = "Pending", ManagerStatus = "Pending", Amount = 75000.00, hoursWorked = 150, Submitted = "2026-04-10", Month = "February 2026" });
        }
